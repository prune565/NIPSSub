...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_path', type=str, default="data_files/cwq/train_res_topic_relations.pkl", help='Path to the train pickle file')
    parser.add_argument('--out_dir', type=str, default="data_files/cwq/topic_relation_candidates/", help='Directory to save the results')
