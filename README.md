...
__Note:__ We provide 100 examples of rational paths annotated by GPT-4o for WebQSP dataset in `data_files/`. We will provide all results for WebQSP and CWQ datasets upon acceptance.
